...
TEST_CASE("Automatic matching - market order", "[TradingPlatform][Matching]")
{
...
TEST_CASE("Automatic matching - limit order", "[TradingPlatform][Matching]")
{
    MarketManager market;
...
TEST_CASE("Automatic matching - 'Immediate-Or-Cancel' limit order", "[TradingPlatform][Matching]")
{
    MarketManager market;
...
TEST_CASE("Automatic matching - 'Fill-Or-Kill' limit order (filled)", "[TradingPlatform][Matching]")
{
    MarketManager market;
...
TEST_CASE("Automatic matching - 'Fill-Or-Kill' limit order (killed)", "[TradingPlatform][Matching]")
{
    MarketManager market;
...
TEST_CASE("Automatic matching - 'All-Or-None' limit order several levels full matching", "[TradingPlatform][Matching]")
{
    MarketManager market;
...
TEST_CASE("Automatic matching - 'All-Or-None' limit order several levels partial matching", "[TradingPlatform][Matching]")
{
    MarketManager market;
...
TEST_CASE("Automatic matching - 'All-Or-None' limit order complex matching", "[TradingPlatform][Matching]")
{
    MarketManager market;
...
TEST_CASE("Automatic matching - 'Hidden' limit order", "[TradingPlatform][Matching]")
{
    MarketManager market;
...
TEST_CASE("Automatic matching - stop order", "[TradingPlatform][Matching]")
{
    MarketManager market;
...
TEST_CASE("Automatic matching - stop order with an empty market", "[TradingPlatform][Matching]")
{
    MarketManager market;
...
TEST_CASE("Automatic matching - stop-limit order", "[TradingPlatform][Matching]")
{
    MarketManager market;
...
TEST_CASE("Automatic matching - stop-limit order with an empty market", "[TradingPlatform][Matching]")
{
    MarketManager market;
...
TEST_CASE("Automatic matching - trailing stop order", "[TradingPlatform][Matching]")
{
    MarketManager market;
...
TEST_CASE("In-Flight Mitigation", "[TradingPlatform][Matching]")
{
    MarketManager market;
...
TEST_CASE("Manual matching", "[TradingPlatform][Matching]")
{
    MarketManager market;
