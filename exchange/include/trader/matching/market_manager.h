...
#ifndef TRADING_PLATFORM_MATCHING_MARKET_MANAGER_H
#define TRADING_PLATFORM_MATCHING_MARKET_MANAGER_H
...
/*!
    \namespace TradingPlatform::Matching
...
#endif // TRADING_PLATFORM_MATCHING_MARKET_MANAGER_H
